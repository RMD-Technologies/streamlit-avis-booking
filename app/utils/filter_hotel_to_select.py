...
def filter_hotel_to_select(df_hotels: pd.DataFrame, is_booking_id=False) -> pd.DataFrame:
    """
    ...
    if not is_booking_id:
        ...
        filtered_df = filtered_df[filtered_df["booking_id"].notna() & (filtered_df["booking_id"] != "")]
